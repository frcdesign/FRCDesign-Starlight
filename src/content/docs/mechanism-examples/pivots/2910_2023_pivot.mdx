...
<a href="https://cad.onshape.com/documents/9b839dcfb57e2325343c7e68/w/d4eb9bd29f2760b8b1531c60/e/f0179551d0ae559b6caa8dd6"><ContentFigure src="./img/2910_2023_pivot.webp" alt="2910 Dead Axle Pivot" width="60%">A custom dead-axle pivot with a creative chain tensioning solution.</ContentFigure></a>
...
<ContentFigure src="./img/pivot_link.webp" alt="Pivot Link" width="60%" />
...
<ContentFigure src="./img/planetgear_idler.webp" alt="Chain tensioning mechanism" width="50%"/>

### Triangular Superstructure

<Slides>
  ![Triangular structure](./img/triangles.webp)
  Triangles are strong! This superstructure is incompressible.

  ![Triangular structure detail](./img/triangles2.webp)

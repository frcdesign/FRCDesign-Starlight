---
title: Preparation
description: How to prepare before using the FRCDesign.org Learning Course
---
...
<Aside type="tip">
Sometimes school wifi can block the embedded YouTube videos on the site. If this is the case all of the videos are available for download [here](https://drive.google.com/drive/folders/1GUVB6ZssmJgS3k0waTas5IWN6-LMcRHH?usp=sharing).
</Aside>

## Onshape Classroom

Setting up an [Onshape Classroom](https://www.onshape.com/en/blog/educator-plan-first-robotics-teams) is a great way to track student progress. Creating assignments for the various exercises also makes it easy to review the work students have done; this also useful in case you need to treat exercises as graded assignments.

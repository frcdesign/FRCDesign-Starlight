...
<ContentFigure src="./img/originCubeFeature.webp" alt="Inserting the Origin Cube feature" width="60%">Inserting the Origin Cube feature</ContentFigure>
...
<ContentFigure src="./img/0200-A.webp" alt="Top Level Assembly: 0200-A-Intake. Notice that there is only two mates. The revolute is between the two intake pivot mate connectors, which are attached to the respective origin cubes." />

<ContentFigure src="./img/0210-A.webp" alt="Stationary Components Assembly: 0210-A-Intake Base. The components are group mated and the origin cube is fastened to the origin." />

<ContentFigure src="./img/0210-PS.webp" alt="Stationary Components PS: 0210-A-Intake Base. Notice the intake pivot mate connector, derived from the orange main layout sketch." />

<ContentFigure src="./img/0220-A.webp" alt="Moving Components Assembly: 0220-A-Intake Arm. The components are group mated and the origin cube is fastened to the origin." />

<ContentFigure src="./img/0220-PS.webp" alt="Moving Components PS: 0220-Intake Arm. Notice the intake pivot mate connector, derived from the orange main layout sketch." />

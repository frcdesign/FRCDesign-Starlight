...
![|center](/best-practices/slapdown-intake-example/slapdown-intake-mate-connector.webp)

This mate connector exists in both subassemblies.

![|center](/best-practices/slapdown-intake-example/slapdown-intake-static-connectors.webp)

![|center](/best-practices/slapdown-intake-example/slapdown-intake-arm-connectors.webp)
...
![|center](/best-practices/slapdown-intake-example/slapdown-intake-top-level.webp)
...
![|center](/best-practices/elevatorAssembly.webp)

### Example: 3647 Millennium Falcons 2024 Intake

![|center|Top Level Assembly: 0200-A-Intake. Notice that there is only two mates. The revolute is between the two intake pivot mate connectors, which are attached to the respective origin cubes.](/best-practices/0200-A.webp)

![|center|Stationary Components Assembly: 0210-A-Intake Base. The components are group mated and the origin cube is fastened to the origin.](/best-practices/0210-A.webp)

![|center|Stationary Components PS: 0210-A-Intake Base. Notice the intake pivot mate connector, derived from the orange main layout sketch.](/best-practices/0210-PS.webp)

![|center|Moving Components Assembly: 0220-A-Intake Arm. The components are group mated and the origin cube is fastened to the origin.](/best-practices/0220-A.webp)

![|center|Moving Components PS: 0220-Intake Arm. Notice the intake pivot mate connector, derived from the orange main layout sketch.](/best-practices/0220-PS.webp)
...
![|center](/best-practices/assembly.webp)

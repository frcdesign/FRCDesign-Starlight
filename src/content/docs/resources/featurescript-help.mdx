...
2. Click the rightmost button on the toolbar <img style="display: inline; vertical-align: middle;" src="/resources/images/featurescripts/addCustomFeatures.webp" alt="Add Custom Features" />

...
2. Click the rightmost button on the toolbar <ContentImage src="img/featurescripts/add-custom-features.webp" alt="Add Custom Features" style="display: inline; vertical-align: middle;" />
...
<Aside type="video" title="Video Tutorial" collapse>
<Youtube id="gFpIzdkl2pQ" />
</Aside>

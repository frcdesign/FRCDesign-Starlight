...
2. Click the rightmost button on the toolbar <ContentImage src="img/featurescripts/add-custom-features.webp" alt="Add Custom Features" style="display: inline; vertical-align: middle;" align="none"/>
...
<Aside type="video" title="Video Tutorial">

...
<Tabs>
  <TabItem label="Beginner Challenge">
    ...
    <center><LinkButton href="/mechanism-examples/intake/slapdown/">Slapdown Example Mechanisms</LinkButton></center>
  </TabItem>
  <TabItem label="Advanced Challenge">
    ...
    <center><LinkButton href="/mechanism-examples/intake/linkage/">4-Bar Example Mechanisms</LinkButton></center>
  </TabItem>
</Tabs>

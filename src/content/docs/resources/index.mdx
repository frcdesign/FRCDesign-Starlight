...
[**FRCDesignLib**](/resources/frcdesignlib/): A parts libary for FRC COTS Components.

[**KrayonCAD**](/resources/krayoncad/): A resource integrated with FRCDesignLib that allows people to quickly model out robot architectures.

...
The first method is pretty self explanatory, but if you choose to fork and make a pull request on GitHub, there is some formatting required. Make sure to follow the contribution guide on the [methods of contributing](/contribution/methods-of-contributing/) page to get up and running with GitHub and VS Code.

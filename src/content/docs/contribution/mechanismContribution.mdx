...
As was described in [methods of contributing](methodsOfContributing), there are two methods:
...
The first method is pretty self explanatory, but if you choose to fork and make a pull request on GitHub, there is some formatting required. Make sure to follow the contribution guide on the [methods of contributing](methodsOfContributing) page to get up and running with GitHub and VS Code.
...
Use a 1:1.545 or 1.545:1 aspect ratio. 1:1.545 is the aspect ratio of a picture outputted from Onshape's "print" function using the "tabloid" paper size.

...
`ContentFigure`, `Aside`, `Slides`, and `LinkButton` are available in all `.mdx` files without importing. All other components require an explicit import at the top of the file:

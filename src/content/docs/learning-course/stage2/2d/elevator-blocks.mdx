...
<ContentFigure src="../img/2d/elevator-blocks.webp" alt="Two different types of elevator blocks" width="75%">Two different types of elevator blocks</ContentFigure>

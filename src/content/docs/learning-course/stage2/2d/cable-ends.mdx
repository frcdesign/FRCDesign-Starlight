...
<ContentFigure src="../img/2d/carriage.webp" alt="Elevator carriage with ratchet plate" width="50%">Elevator carriage with ratchet plate</ContentFigure>
...
<ContentFigure src="../img/2d/ratchet-plate.webp" alt="Close up of ratchet plate" width="50%">Close up of ratchet plate</ContentFigure>

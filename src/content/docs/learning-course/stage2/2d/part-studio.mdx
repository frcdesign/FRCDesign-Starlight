...
<ContentFigure src="../img/2d/tubesAndCrushblocks.webp" alt="Finished elevator tubes" />
...
<ContentFigure src="../img/2d/elevatorPartStudio.webp" alt="Finished elevator part studio" />

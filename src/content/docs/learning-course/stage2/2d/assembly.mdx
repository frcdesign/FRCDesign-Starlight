...
![Finished base stage assembly |center|85%|Finished base stage assembly](/learning-course/stage2-elevator/frameSubassembly.webp)

### First Stage Assembly

Do the same thing for the first stage subassembly.

![Finished first stage assembly |center|85%|Finished first stage assembly](/learning-course/stage2-elevator/stage1Subassembly.webp)

### Carriage Assembly

And finally the carriage subassembly.

![Finished carriage assembly |center|75%|Finished carriage assembly](/learning-course/stage2-elevator/carriageSubassembly.webp)
...
![Finished Top Level Elevator Assembly |center|75%|Finished Top Level Elevator Assembly](/learning-course/stage2-elevator/elevatorTopLevel.webp)

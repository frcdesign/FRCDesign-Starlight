---
title: Spin Control
description: Understanding spin control in shooters
---
...
<Slides images={[
  { src: "/learning-course/stage2-shooter/bounceout.webm", alt: "Bounceout caused by too much spin" },
]}>

Bounceout caused by too much spin. Credit: FRC Team 7492
...
<Slides images={[
  { src: "https://www.youtube.com/embed/1b8spBWIAT4?si=daEZUNFTRv_rsYMn", alt: "High speed shooter video" },
]}>

This high speed shooter video uses PTFE tape to lower the friction on the hood backing to reduce some of the spin. This led to a higher exit velocity by 2 miles per hour.
...
<Slides images={[
  { src: "https://www.youtube.com/embed/QZKDnRvLhrA?si=9ZoKnbHI4jayoux0&start=5", alt: "Ball spin observation" },
]}>

Observe how the ball spins as it travels along the shooter path. Despite the presence of back rollers, some spin is still evident.

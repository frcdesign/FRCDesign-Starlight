...
![COTS 1/2 hex delrin spacer |center|60%|A COTS 1/2 hex delrin spacer which is used to reduce friction and constrain the object.](/learning-course/stage2-shooter/hexspacers.webp)
...
<Aside type="example">
<Slides>
  ![Overconstrained shaft example](/learning-course/stage2-shooter/overconstrained-shaft.webp)
  Example of a shaft being overconstrained by having a fixed bearing in the middle of the shaft.

  ![Properly constrained shaft example](/learning-course/stage2-shooter/proper-constraint.webp)

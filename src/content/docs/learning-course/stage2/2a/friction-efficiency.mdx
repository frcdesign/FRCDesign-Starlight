...
<center>
  <ContentImage src="/learning-course/stage2-shooter/hexspacers.webp" alt="COTS 1/2 hex delrin spacer" style="width:60%; border-radius: 2%" />
</center>
<center>*A COTS 1/2 hex delrin spacer which is used to reduce friction and constrain the object.*</center>
...
<Aside type="example">
<Slides images={[
  { src: "/learning-course/stage2-shooter/overconstrained-shaft.webp", alt: "Overconstrained shaft example" },
  { src: "/learning-course/stage2-shooter/proper-constraint.webp", alt: "Properly constrained shaft example" },
]}>

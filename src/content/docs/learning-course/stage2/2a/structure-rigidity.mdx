...
![1x1 structure with gussets |center|60%|1x1 structure with the gussets helping support the polycarbonate plates.](/learning-course/stage2-shooter/shooterfront.webp)

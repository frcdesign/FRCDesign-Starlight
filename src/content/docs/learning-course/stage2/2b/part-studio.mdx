---
title: Part Studio
description: Modeling the pivot in Part Studio
---
...
<center>
  <ContentImage src="/learning-course/stage2-pivot/PivotPartStudio.webp" alt="Finished part studio" style="width:70%" />
</center>

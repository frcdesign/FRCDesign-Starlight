...
<ContentFigure src="../img/2b/Dead Axle Subassembly.webp" alt="Finished Base Subassembly" />
...
<ContentFigure src="../img/2b/Arm Subassembly.webp" alt="Finished Arm Subassembly" />
...
<ContentFigure src="../img/2b/deadAxleInstanceList.webp" alt="Instance list of a rigid assembly" />
</Aside>
...
<ContentFigure src="../img/2b/Top Level Pivot.webp" alt="Finished Top Level Pivot Assembly" />

...
<ContentFigure src="img/formula.webp" alt="Formula 1 car">Formula 1 race cars are an example of something that is modeled in CAD.</ContentFigure>
...
<ContentFigure src="img/bread.webp" alt="Bread robot meme" width="40%"/>

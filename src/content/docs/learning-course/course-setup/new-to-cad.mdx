...
![Formula 1 Racecar in SolidWorks|Formula 1 race cars are an example of something that is modeled in CAD.|||3px solid #ADADAD](img/formula.webp)
...
![5940 Bread's 2023 Robot||90%](img/bread.webp)

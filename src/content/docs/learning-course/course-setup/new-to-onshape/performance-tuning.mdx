...
- First, type `chrome://settings/` in your search bar to navigate to chrome settings. Make sure that "Use graphics acceleration when available" is enabled. Relaunch chrome if you have updated it to enable it.
  ...
  ![Graphics acceleration setting |center|80%](/learning-course/course-setup/performance-tuning/graphicsacceleration.webp)

- Go to `chrome://flags/` and enable "Override Software Rendering List":

  ![Override rendering list |center|80%](/learning-course/course-setup/performance-tuning/override-rendering-list.png)

- Finally, Try adjusting your ANGLE graphics backend:

  ![ANGLE backend |center|80%](/learning-course/course-setup/performance-tuning/ANGLE-backend.png)

...
<Aside type="tip">
Remember to take a look at the [website feature guide](/website-feature-guide) to gain an understanding of the different features used throughout the learning course!
</Aside>
...
<Slides
  images={[
    { src: "/learning-course/course-setup/account-setup/signup.webp", caption: "Fill out the details in the sign up form." },
    { src: "/learning-course/course-setup/account-setup/edusignup2.webp", caption: "On the next screen, select that you are a student and that you are in grade school." },
    { src: "/learning-course/course-setup/account-setup/edusignup3.webp", caption: "Finally, fill the form with your school information. You may enter \"Robotics\" as the reason for using Onshape." }
  ]}
/>
...
<center><img src="/learning-course/course-setup/account-setup/units.webp" style="width:60%; border:5px solid #ADADAD; border-radius: 2%" alt="Onshape units setup" /></center>

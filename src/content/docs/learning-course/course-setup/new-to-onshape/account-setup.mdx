...
<Slides
  images={[
    { src: "/learning-course/course-setup/account-setup/signup.webp" },
    { src: "/learning-course/course-setup/account-setup/edusignup2.webp" },
    { src: "/learning-course/course-setup/account-setup/edusignup3.webp" },
  ]}>
...
<center><ContentImage src="/learning-course/course-setup/account-setup/units.webp" alt="Onshape units setup" style="width:60%; border:5px solid #ADADAD; border-radius: 2%" /></center>

...
<Slides>
  ![||||3px solid #ADADAD](/learning-course/course-setup/account-setup/signup.webp)
  Fill out the details in the sign up form.

  ![||||3px solid #ADADAD](/learning-course/course-setup/account-setup/edusignup2.webp)
  On the next screen, select that you are a student and that you are in grade school.

  ![||||3px solid #ADADAD](/learning-course/course-setup/account-setup/edusignup3.webp)
...
![Onshape units setup |center|60%](/learning-course/course-setup/account-setup/units.webp)

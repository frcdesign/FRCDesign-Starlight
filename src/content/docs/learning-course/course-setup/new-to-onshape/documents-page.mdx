...
description: Understanding the Onshape documents page
---
...
<center><ContentImage src="/learning-course/course-setup/navigation/documentsPage.webp" alt="Onshape documents page" style="width:90%; border:5px solid #ADADAD" /></center>
...
<center><ContentImage src="/learning-course/course-setup/navigation/public-search-results.webp" alt="Public search results" style="width:90%; border:5px solid #ADADAD" /></center>
...
<Aside type="tip">
You can complete the [Navigating Onshape Course](https://learn.onshape.com/learn/course/navigating-onshape/onshape-interface/the-documents-page?page=1) in the Onshape learning center to learn more about the documents page.
</Aside>

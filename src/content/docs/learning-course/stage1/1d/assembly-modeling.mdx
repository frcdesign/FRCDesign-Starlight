...
<Slides images={[
  { src: "/learning-course/stage1/1d/drivetrain/assy-0.webp" },
  { src: "/learning-course/stage1/1d/drivetrain/assy-1.webp" },
  { src: "https://www.youtube.com/embed/vPjp-Xay10s?controls=1&rel=0&showinfo=0&vq=hd1080" },
  { src: "https://www.youtube.com/embed/PA8D-PvsyF0?controls=1&rel=0&showinfo=0&vq=hd1080" },
  { src: "/learning-course/stage1/1d/drivetrain/assy-4.webp" },
  { src: "/learning-course/stage1/1d/drivetrain/assy-0.webp" }
]}>
...
2. Insert the simplified MK4i module from FRCDesignLib into the assembly and mate it into place.

3. Use the Circular Pattern assembly tool to finish assembling the modules.

4. Insert, fasten, and replicate the 3/16" Aluminum Blind Rivet (WCP) (.125" - .250" Grip Length) from FRCDesignLib onto the bellypan holes. Make sure to leave the three holes shown in the image empty on each side for bolts to be added when the gusset is modeled and added.
...
<figure>
    <ContentImage src="/learning-course/stage1/1d/pop-rivet-steps.webp" alt="Pop rivet installation steps" width="100%" style="border:5px solid #ADADAD; border-radius: 2%" />

...
<center>
<LinkButton href="https://cad.onshape.com/documents/28a750426de8e2bc17d5b900/w/8e79c6217ae2ce07ff57d900/e/a4d266d03289620078d13a80" external>1678 2023 Scoring Mechanism Document</LinkButton>
</center>
...
<Slides images={[
  { src: "/learning-course/stage1/1d/top-level/top-level-0.webp" },
  { src: "https://www.youtube.com/embed/Vk3D0JNBKhI?controls=1&rel=0&showinfo=0&vq=hd1080" },
  { src: "https://www.youtube.com/embed/KVQqbvh1NOE?controls=1&rel=0&showinfo=0&vq=hd1080" },
  { src: "/learning-course/stage1/1d/top-level/top-level-0.webp" }
]}>

0. Finished top level robot assembly.

1. Insert the drivetrain assembly and fasten the origin cube to the assembly origin. You may need to unhide the origin cube to mate it.

2. Insert the 1678 2023 scoring assembly by pasting the scoring mechanism link into the Insert menu textbox. Then, fasten its origin cube to the assembly origin. You may need to hide the drivetrain's origin cube to access the origin of the assembly for mating.

3. Finished top level assembly.
...
<figure>
<ContentImage src="/learning-course/stage1/1d/tab-manager-2.webp" alt="Tab manager with top level assembly" style="width:100%" />
</figure>
</Aside>

...
<Slides images={[
  { src: "/learning-course/stage1/1d/top-level/top-level-0.webp", caption: "0. Finished top level robot assembly." },
  { src: "https://www.youtube.com/embed/Vk3D0JNBKhI?controls=1&rel=0&showinfo=0&vq=hd1080", caption: "1. Insert the drivetrain assembly and fasten the origin cube to the assembly origin. You may need to unhide the origin cube to mate it." },
  { src: "https://www.youtube.com/embed/KVQqbvh1NOE?controls=1&rel=0&showinfo=0&vq=hd1080", caption: "2. Insert the 1678 2023 scoring assembly by pasting the scoring mechanism link into the Insert menu textbox. Then, fasten its origin cube to the assembly origin. You may need to hide the drivetrain's origin cube to access the origin of the assembly for mating." },
  { src: "/learning-course/stage1/1d/top-level/top-level-0.webp", caption: "3. Finished top level assembly." }
]} />

...
<figure>
    <img src="/learning-course/stage1/1d/drivetrain-assembly.webp" style="width:80%" alt="Stage 1D swerve drivebase" />
    <figcaption>Stage 1D swerve drivebase project.</figcaption>
</figure>

As with previous exercises, the finished project is available for reference. If you need help, please feel free to ask on [the Discord](https://discord.gg/qdx7pdZKx4)!

<center>
<LinkButton href="https://cad.onshape.com/documents/6c6044229091a87cf359270b/w/ed9648f0c04c639a2561615a/e/67a7ed0c6038787281325a51" external>1D Drivebase Reference</LinkButton>
</center>

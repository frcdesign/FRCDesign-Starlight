---
title: Design Methodology Introduction
description: Introduction to design methodology
sidebar:
  order: 0
---
...
<ContentFigure src="../img/1d/full-assembly.webp" alt="Stage 1D swerve drivebase with scoring mechanism" width="50%">The swerve drivebase that you will be modeling with a pre-modeled scoring mechanism.</ContentFigure>

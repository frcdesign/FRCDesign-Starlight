...
<ContentFigure src="../img/1d/full-assembly.webp" alt="Stage 1D swerve drivebase with scoring mechanism">The swerve drivebase that you will be modeling with a pre-modeled scoring mechanism.</ContentFigure>

...
<figure>
  <img src="/learning-course/stage1/1d/define-holes.webp" style="width:60%; border:5px solid #ADADAD; border-radius: 2%" alt="Manually defined mounting holes" />
</figure>
</Aside>

<Slides images={[
  { src: "/learning-course/stage1/1d/drivetrain/add-0.webp", caption: "0. Finished drivetrain assembly." },
  { src: "/learning-course/stage1/1d/drivetrain/add-1.webp", caption: "1. Sketch and extrude a 1/8\" thick gusset to connect the crosstube to the top of the frame using the holes shown." },
  { src: "https://www.youtube.com/embed/n8lWSdOV-Ks?controls=1&rel=0&showinfo=0&vq=hd1080", caption: "2. Insert the gusset into the assembly and add it to the Group." },
  { src: "/learning-course/stage1/1d/drivetrain/add-3.webp", caption: "3. Add 2-1/2\" #10-32 bolts to the three holes in the bellypan on each side so they go through the gusset holes on the other side. Add nylock nuts to the holes on the gusset. As you learned in 1C, this is to help prevent rivets from loosening and falling out over time." },
  { src: "https://www.youtube.com/embed/CC017qPw2Mk?controls=1&rel=0&showinfo=0&vq=hd1080", caption: "4. Edit the replicate feature to add rivets to the gusset." },
  { src: "https://www.youtube.com/embed/0O1ojhHTgMI?controls=1&rel=0&showinfo=0&vq=hd1080", caption: "5. Mirror the gusset, bolts, and rivets to the other side of the drivetrain using a mate connector on the origin cube." },
  { src: "/learning-course/stage1/1d/drivetrain/add-0.webp", caption: "6. Finished drivetrain assembly." }
]} />
...
<figure>
  <img src="/learning-course/stage1/1d/tab-manager.webp" style="width:100%" alt="Tab manager view" />
</figure>
</Aside>

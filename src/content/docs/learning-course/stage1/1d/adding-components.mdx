...
<figure>
  <ContentImage src="/learning-course/stage1/1d/define-holes.webp" alt="Manually defined mounting holes" style="width:60%; border:5px solid #ADADAD; border-radius: 2%" />
</figure>
</Aside>

<Slides images={[
  { src: "/learning-course/stage1/1d/drivetrain/add-0.webp" },
  { src: "/learning-course/stage1/1d/drivetrain/add-1.webp" },
  { src: "https://www.youtube.com/embed/n8lWSdOV-Ks?controls=1&rel=0&showinfo=0&vq=hd1080" },
  { src: "/learning-course/stage1/1d/drivetrain/add-3.webp" },
  { src: "https://www.youtube.com/embed/CC017qPw2Mk?controls=1&rel=0&showinfo=0&vq=hd1080" },
  { src: "https://www.youtube.com/embed/0O1ojhHTgMI?controls=1&rel=0&showinfo=0&vq=hd1080" },
  { src: "/learning-course/stage1/1d/drivetrain/add-0.webp" }
]}>

0. Finished drivetrain assembly.

1. Sketch and extrude a 1/8" thick gusset to connect the crosstube to the top of the frame using the holes shown.

2. Insert the gusset into the assembly and add it to the Group.

3. Add 2-1/2" #10-32 bolts to the three holes in the bellypan on each side so they go through the gusset holes on the other side. Add nylock nuts to the holes on the gusset. As you learned in 1C, this is to help prevent rivets from loosening and falling out over time.

4. Edit the replicate feature to add rivets to the gusset.

5. Mirror the gusset, bolts, and rivets to the other side of the drivetrain using a mate connector on the origin cube.

6. Finished drivetrain assembly.
...
<figure>
  <ContentImage src="/learning-course/stage1/1d/tab-manager.webp" alt="Tab manager view" style="width:100%" />
</figure>
</Aside>

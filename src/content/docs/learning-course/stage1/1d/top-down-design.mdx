...
<ContentFigure src="../img/1d/example-master-sketch.webp" alt="Example main layout sketch" width="60%">Example of robot main layout sketches. Each mechanism has a number of layout sketches that capture the important details. (Photo Credit: FRC 3647)</ContentFigure>
</Aside>

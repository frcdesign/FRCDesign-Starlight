...
description: Review and summary of subsystem workflow
---
...
Make sure to review all the CAD you've done using [the review instruction page](/learning-course/stage1/1a/focusing-on-improvement "Focusing on Improvement Page"). If you copied the reference through the instruction slides, you can check against the solution document; otherwise, just exclude that step from the review.

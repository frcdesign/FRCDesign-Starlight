...
<Slides>
  ![](/learning-course/stage1/1e/bumper-mount/bumper-mount-0.webp)
  Finished bumper mounts.

  ![](/learning-course/stage1/1e/bumper-mount/bumper-mount-1.webp)
  Model the bumper mount. This part should be 3/16" thick aluminum. The threaded stud falls into the slot.

  ![](/learning-course/stage1/1e/bumper-mount/bumper-mount-2.webp)
  ...
  ![](/learning-course/stage1/1e/bumper-mount/bumper-mount-3.webp)
  Fillet and optionally pocket the mount. 0.15" wide ribs and 1/8" tool radius are recommended.

  ![](/learning-course/stage1/1e/bumper-mount/bumper-mount-4.webp)

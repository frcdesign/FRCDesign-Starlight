...
<ContentFigure src="../img/1e/bumper-mount/stud-mount.webp" alt="Section view of the threaded stud bumper mount system" width="70%">Section view of the threaded stud bumper mount system. The threaded stud is attached to the bumper wood and the nut holds the bumpers tight against the frame.</ContentFigure>
</Aside>

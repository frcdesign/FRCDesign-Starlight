---
title: "1A: Exercise 2 - Cross Rails"
...
<YouTube id="iDWhp80-axc">Drivetrain in action</YouTube>
...
<div style="display: flex; gap: 5px; align-items: flex-start;">
  <figure style="flex: 1;">
    <img src="/learning-course/stage1a/dt-top.webp" style="width:90%" />
    <figcaption>Missing Cross Rails</figcaption>
  </figure>

  <figure style="flex: 1;">
    <img src="/learning-course/stage1a/drivetrain-example.webp" style="width:90%" />
...
<figure>
  <img src="/learning-course/stage1a/noclipping.webp" style="width:70%" />
...
<YouTube id="Wr5-n--PbuI">Changing part appearance</YouTube>

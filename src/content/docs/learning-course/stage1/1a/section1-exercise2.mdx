...
<div style="display: flex; gap: 5px; align-items: flex-start;">
  <figure style="flex: 1;">
    <ContentImage src="/learning-course/stage1a/dt-top.webp" style="width:90%" />
    <figcaption>Missing Cross Rails</figcaption>
  </figure>

  <figure style="flex: 1;">
    <ContentImage src="/learning-course/stage1a/drivetrain-example.webp" style="width:90%" />
...
<figure>
  <ContentImage src="/learning-course/stage1a/noclipping.webp" style="width:70%" />

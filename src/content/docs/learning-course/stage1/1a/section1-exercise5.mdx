...
<ContentFigure src="../img/1a/exercise-5-973-example.webp" alt="973's 2022 Superstructure" width="60%" border>973's 2022 Superstructure</ContentFigure>

In this exercise we'll be adding a simple box tube frame to the drivetrain you made previously.

<ContentFigure src="../img/1a/exercise5-frame.webp" alt="Final Box Tube Frame" width="80%">Final Box Tube Frame</ContentFigure>
...
<ContentFigure src="../img/1a/side profile.webp" alt="Box superstructure sketch" width="80%">Box superstructure sketch</ContentFigure>

...
<ContentFigure src="../img/1a/superstructure-gusset-example.webp" alt="Superstructure gusset example layout" width="75%">Superstructure gusset example layout</ContentFigure>

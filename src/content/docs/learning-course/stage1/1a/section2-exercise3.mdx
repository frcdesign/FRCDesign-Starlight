...
description: Create gussets and plates for a superstructure
---
...
<ContentFigure src="../img/1a/superstructure-gusset-example.webp" alt="Superstructure gusset example layout" width="60%">Superstructure gusset example layout</ContentFigure>
...
<Aside type="tip" title="Materials">

...
<ContentFigure src="../img/1a/extrude-individual.webp" alt="Using Symmetric inside Extrude Individual." width="90%">Using "Symmetric" inside Extrude Individual.</ContentFigure>
...
<ContentFigure src="../img/1a/drivetrain-crossrail-sketch2.webp" alt="Final cross rail sketch setup." width="90%">Final cross rail sketch setup.</ContentFigure>

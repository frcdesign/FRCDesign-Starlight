...
:::figure{w=70}
![Starting setup with four rectangles.](../img/1a/exercise3-rectangles.webp)
Starting setup with four rectangles.
:::
...
<YouTube id="2Jzb1Xr6NBE">How to delete extrudes</YouTube>
...
:::figure{w=90}
![Using "Symmetric" inside Extrude Individual.](../img/1a/extrude-individual.webp)
Using "Symmetric" inside Extrude Individual.
:::
...
<YouTube id="ftbpbvuZklc">Sketching fundamentals in Onshape</YouTube>
...
:::figure
![Edit this sketch](../img/1a/3-2-sketch.webp)
Edit this sketch
:::
...
:::figure{w=90}
![Final cross rail sketch setup.](../img/1a/drivetrain-crossrail-sketch2.webp)
Final cross rail sketch setup.
:::
...
<YouTube id="ktKuSFVV10U">Optimized cross rail sketch</YouTube>

...
description: A structured approach to improving your CAD skills through exercises
---
...
<Aside type="tip" title="OPTIONAL: Time Yourself">
...
<Aside type="tip" title="OPTIONAL: Have a Mentor Help Review">

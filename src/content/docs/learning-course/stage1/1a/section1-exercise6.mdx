...
<ContentFigure src="../img/1a/exercise6-triangle-frame.webp" alt="Triangle frame example (angled box tubes)">Triangle frame example (angled box tubes)</ContentFigure>

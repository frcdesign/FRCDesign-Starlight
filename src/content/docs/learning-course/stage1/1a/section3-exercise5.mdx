...
<ContentFigure src="../img/1a/superstructure-gusset-example.webp" alt="Section 2: Exercise 3 Part Studio Example" width="75%">Section 2: Exercise 3 Part Studio Example</ContentFigure>

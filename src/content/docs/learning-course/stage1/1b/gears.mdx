...
<Gif src="/learning-course/simple-gears.webp" alt="Simple gears animation" />
<Gif src="/learning-course/gearbox-animated.webp" alt="Gearbox animation" />
</div>
Animations of gears meshing. Notice that meshed gears will spin in opposite directions.
:::
...
:::figure{w=70}
![Gear pitch diagram](../img/1b/gears/gear-diagram.webp)
Illustration of a gear's pitch diameter and outer diameter. (Image source: WCP).
:::
...
:::figure{w=60}
![CAD gear modeling](../img/1b/gears/gear-cad.webp)
Modeling gear C-C distance by constraining two pitch diameter construction circles tangent. The diameters of the circle are calculated by dividing the tooth count by DP, which is 20 in this case.
:::

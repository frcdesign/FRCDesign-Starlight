...
![Simple gears animation |center|100%](/learning-course/stage1/1b/gears/simple-gears.gif)
![Gearbox animation |center|100%](/learning-course/stage1/1b/gears/gearbox-animated.gif)
</div>
...
<center>**`C2C = 0.5 * PD1 + 0.5 * PD2`**</center>

...
<figure>
    <ContentImage src="/learning-course/stage1/1b/chain/chain-animation.gif" alt="Chain and sprocket animation" style="width:40%" />
    <figcaption>A simple animation of chain and sprocket. Notice that the sprockets will spin in the same direction.</figcaption>
</figure>
...
<figure>
    <ContentImage src="/learning-course/stage1/1b/chain/chain-diagram.webp" alt="Chain sprocket diagram" style="width:70%" />
    <figcaption>Illustration of chain sprocket diameter measures. (Image source: WCP)</figcaption>
</figure>
...
<figure>
    <ContentImage src="/learning-course/stage1/1b/chain/turnbuckle.webp" alt="Turnbuckle chain tensioner" style="width:60%" />

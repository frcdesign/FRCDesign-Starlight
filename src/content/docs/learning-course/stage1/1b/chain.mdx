...
<ContentFigure src="../img/1b/chain/turnbuckle.webp" alt="Turnbuckle chain tensioner" width="60%">A "turnbuckle" or "inline" chain tensioner. The turnbuckle acts as a variable-length link in the chain that can be adjusted to keep the chain tight. (Photo Credit: FRC 1538)</ContentFigure>
</Aside>

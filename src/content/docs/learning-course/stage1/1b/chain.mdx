...
<Gif src="/learning-course/chain-animation.webp" center scale="40%" alt="Chain and sprocket animation">A simple animation of chain and sprocket. Notice that the sprockets will spin in the same direction.</Gif>
...
:::figure{w=70}
![Chain sprocket diagram](../img/1b/chain/chain-diagram.webp)
Illustration of chain sprocket diameter measures. (Image source: WCP)
:::
...
:::figure{w=60}
![Turnbuckle chain tensioner](../img/1b/chain/turnbuckle.webp)
A "turnbuckle" or "inline" chain tensioner. The turnbuckle acts as a variable-length link in the chain that can be adjusted to keep the chain tight. (Photo Credit: FRC 1538)
:::
</Aside>

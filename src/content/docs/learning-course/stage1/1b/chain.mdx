...
<ContentFigure src="../img/1b/chain/chain-animation.webp" gif width="40%" alt="Chain and sprocket animation">A simple animation of chain and sprocket. Notice that the sprockets will spin in the same direction.</ContentFigure>

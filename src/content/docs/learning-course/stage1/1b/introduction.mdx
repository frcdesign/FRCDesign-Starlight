...
<Slides
  images={[
    { src: "/learning-course/stage1/1b/examples/intake-rollers.webp", caption: "Belt and gear power transmission to spin intake rollers. (Photo Credit: FRC 3647)" },
    { src: "/learning-course/stage1/1b/examples/intake-pivot.webp", caption: "Gear and chain power transmission to pivot the intake. (Photo Credit: FRC 3647)" },
    { src: "/learning-course/stage1/1b/examples/shooter.webp", caption: "Belt and gear power transmission to spin shooter wheels. (Photo Credit: FRC 3647)" },
    { src: "/learning-course/stage1/1b/examples/amp-arm.webp", caption: "Gear and chain power transmission to rotate a small arm. (Photo Credit: FRC 3647)" },
    { src: "/learning-course/stage1/1b/examples/arm-gearbox.webp", caption: "Gear and chain power transmission to rotate a large arm. (Photo Credit: FRC 3647)" }
  ]}
/>

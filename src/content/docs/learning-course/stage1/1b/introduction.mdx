...
<Slides
  images={[
    { src: "/learning-course/stage1/1b/examples/intake-rollers.webp" },
    { src: "/learning-course/stage1/1b/examples/intake-pivot.webp" },
    { src: "/learning-course/stage1/1b/examples/shooter.webp" },
    { src: "/learning-course/stage1/1b/examples/amp-arm.webp" },
    { src: "/learning-course/stage1/1b/examples/arm-gearbox.webp" },
  ]}>

...
<Slides
  images={[
    { src: "/learning-course/stage1/1b/exercises/exercise1/parts-0.webp", caption: "0. Finished Part Studio." },
    { src: "/learning-course/stage1/1b/exercises/exercise1/parts-1.webp", caption: "1. Begin by creating the layout sketch for the gearbox. Draw the pitch circles for the 60T and 12T gears. Set the pitch circles tangent to constrain the center-to-center distance between the gears. Constrain the centers of the two gears to be vertical." },
    { src: "/learning-course/stage1/1b/exercises/exercise1/parts-2.webp", caption: "2. Add the outline of the motor, a 2.5\" diameter circle, around the 12T gear that the motor is attached to. The layout sketch is now finished." },
    { src: "/learning-course/stage1/1b/exercises/exercise1/parts-3.webp", caption: "3. Create a new sketch for the motor plate. Using the layout as the reference, draw a 1.125\" hole for the bearing and a 1.25\" hole for the motor boss (the nub that sticks out from the motor). Note that depending on your manufacturing processes and tolerances, you may need to draw your bearing holes slightly larger or smaller than nominal (1.125\")." },
    { src: "/learning-course/stage1/1b/exercises/exercise1/parts-4.webp", caption: "4. Add two mounting holes for the motor on a 2\" bolt circle. When using only two mounting holes, an alternative to using a circular pattern is to draw and dimension a 2\" construction circle, then draw the holes for the bolts on the circle. Make sure to constrain the angle of the holes as well; we used a horizontal constraint." },
    { src: "/learning-course/stage1/1b/exercises/exercise1/parts-5.webp", caption: "5. Add the four bolt holes for connecting the two plates. Use a center rectangle to create the construction geometry so that only two dimensions are required to constrain the holes." },
    { src: "/learning-course/stage1/1b/exercises/exercise1/parts-6.webp", caption: "6. Using centerpoint arcs, lines, and the sketch mirror tool, draw the outline for the plate around the holes and motor outline. The intelligent placement of the origin along the vertical line of symmetry allows you to use the right plane to mirror the plate outline." },
    { src: "/learning-course/stage1/1b/exercises/exercise1/parts-7.webp", caption: "7. Extrude the motor plate to be 1/4\" thick." },
    { src: "/learning-course/stage1/1b/exercises/exercise1/parts-8.webp", caption: "8. Use the Robot Spacer Featurescript to add #10 free fit, 3/8\" OD (automatic), 3/4\" long spacer." },
    { src: "/learning-course/stage1/1b/exercises/exercise1/parts-9.webp", caption: "9. Create the outer plate sketch on the face of the spacer. Use the Use sketch tool to project the holes and edges of the motor plate, but add a round cutout at the top using one of the arc tools. Note that the sketch can be mostly defined by using constraints such as tangent, equal, and vertical." },
    { src: "/learning-course/stage1/1b/exercises/exercise1/parts-10.webp", caption: "10. Extrude the outer plate to be 1/4\" thick." }
  ]}
/>

<YouTube id="RDXcECn8uSI" caption="11. Use the Robot Shaft Featurescript to model the output shaft. Follow the settings used." />

<figure>
  <img src="/learning-course/stage1/1b/exercises/exercise1/parts-0.webp" style="width:100%" alt="Finished part studio" />
  <figcaption>12. Finished part studio. Name the key sketches and features. Set the name, material (6061 Aluminum), and appearance of the plates and spacer by right clicking the parts in the part list. The shaft has its material automatically determined from the Robot Shaft Featurescript.</figcaption>
</figure>
...
<YouTube id="zI8wBHeTfdc" caption="Using the Shift key to lock mate inferences while mating" />
...
<Slides
  images={[
    { src: "/learning-course/stage1/1b/exercises/exercise1/assy-0.webp", caption: "0. Final assembly." }
  ]}
/>

<YouTube id="kChIFuuLahU" caption="1. Insert the part studio into the assembly and fix the gearbox plate. Group mate the two plates together and then mate the spacer to the motor plate. Then, use the Replicate tool to replicate the spacer and its associated mate onto the other spacer locations." />

<YouTube id="gKP-n5eKmjE" caption="2. Assemble the bearings and shaft using parts from FRCDesignLib." />

<YouTube id="ZJCs0ms3I8A" caption="3. Assemble the motor and motor pinion gear using parts from FRCDesignLib. You will need to use mate inference locking to fasten the motor to the motor pinion: See the above drop down to learn how." />

<YouTube id="mMP-kkl6AuY" caption="4. Assemble the shaft spacer and gear using parts from FRCDesignLib. Configurable parts will have a blue grid icon in the instance list. Notice how you were able to change the tooth count of the gear from 40T to 60T after mating it. Using configurable components like this makes your models more parametric since you can change the component without needing to re-insert and mate." />

<YouTube id="SytVbO_-BrM" caption="5. Insert the shaft retention bolts from FRCDesignLib." />

<YouTube id="D4OWWMYYwWM" caption="6. Add the motor bolts, gearbox bolts, and nuts using FRCDesignLib parts." />

<figure>
  <img src="/learning-course/stage1/1b/exercises/exercise1/assy-0.webp" style="width:100%" alt="Final assembly" />

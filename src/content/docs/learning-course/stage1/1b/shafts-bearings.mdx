...
<figure>
    <ContentImage src="/learning-course/stage1/1b/examples/bearing-and-shaft.webp" alt="Bearing and shaft" style="width:75%" />
...
<figure>
    <ContentImage src="/learning-course/stage1/1b/examples/shaft-spinning.webp" alt="Shaft spinning in bearings" style="width:100%" />
...
<figure>
    <ContentImage src="/learning-course/stage1/1b/examples/bushing.webp" alt="Bronze bushing" style="width:50%" />

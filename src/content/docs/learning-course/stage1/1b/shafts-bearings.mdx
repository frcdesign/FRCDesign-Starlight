...
::figure{w=75}
<ContentFigure src="../img/1b/examples/bearing-and-shaft.webp" alt="Bearing and shaft" />
...
<ContentFigure src="/learning-course/shaft-spinning.webp" alt="Shaft spinning in bearings">A spinning shaft in bearings</ContentFigure>
</Aside>

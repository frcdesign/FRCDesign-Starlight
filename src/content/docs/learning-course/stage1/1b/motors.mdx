...
<figure>
    <ContentImage src="/learning-course/stage1/1b/examples/motor-lineup.webp" alt="FRC Motor lineup" style="width:100%" />
...
<figure>
    <ContentImage src="/learning-course/stage1/1b/examples/cim-bolt-circle.webp" alt="CIM bolt circle" style="width:50%" />

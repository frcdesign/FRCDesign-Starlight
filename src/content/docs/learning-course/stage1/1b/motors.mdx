---
title: Motors
description: Introduction to motors in FRC
---
...
<ContentFigure src="../img/1b/examples/motor-lineup.webp" alt="FRC Motor lineup">Some of the motors available for use in FRC.</ContentFigure>
...
<ContentFigure src="../img/1b/examples/cim-bolt-circle.webp" alt="CIM bolt circle" width="50%">Mounting holes for CIM class motors are on a 2" diameter bolt circle. All of the holes are 1" away from the center of the motor.</ContentFigure>

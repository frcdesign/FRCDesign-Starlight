...
description: Introduction to the FRCDesign.org learning course approach
---
...
During the season, copying and referencing past designs is encouraged; you'll learn a ton by studying how others solved problems and adapting those ideas to your own designs. However, your ability to effectively use those references depends on the skills you build *before* the season starts.

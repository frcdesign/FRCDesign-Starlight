...
<Slides images={[
  { src: "/learning-course/stage1/1c/exercise1-layout.webp", caption: "Exercise 1 layout sketch. Notice that only key geometry details are included in the layout sketch." },
  { src: "/learning-course/stage1/1c/exercise1-layout-final.webp", caption: "Exercise 1 side view. Notice how the layout sketch drives the geometry of the mechanism." }
]} />
...
<Slides images={[
  { src: "/learning-course/stage1/1c/origin-cube-tutorial/origin-cube-tutorial-1.webp", caption: "Place the Origin Cube featurescript as the first feature in the part studio." },
  { src: "/learning-course/stage1/1c/origin-cube-tutorial/origin-cube-tutorial-2.webp", caption: "Model your mechanism." },
  { src: "https://www.youtube.com/embed/H6y1S_cHLKk", caption: "Insert the part studio into the assembly with the green checkmark. Group all static parts together with the Origin Cube part, then fasten the mate connector on the Origin Cube to the origin of the assembly." }
]} />

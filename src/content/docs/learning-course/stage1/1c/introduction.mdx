...
<Slides>
  ![](/learning-course/stage1/1c/exercise1-layout.webp)
  Exercise 1 layout sketch. Notice that only key geometry details are included in the layout sketch.

  ![](/learning-course/stage1/1c/exercise1-layout-final.webp)
...
<Slides>
  ![](/learning-course/stage1/1c/origin-cube-tutorial/origin-cube-tutorial-1.webp)
  Place the Origin Cube featurescript as the first feature in the part studio.

  ![](/learning-course/stage1/1c/origin-cube-tutorial/origin-cube-tutorial-2.webp)

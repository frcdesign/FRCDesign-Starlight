...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
  <center><ContentImage src="/learning-course/stage1/1c/telescope/greyt.webp" alt="GreyT Telescope" width="100%" /></center>
  <center><ContentImage src="/learning-course/stage1/1c/telescope/maxplanetary.webp" alt="MAXPlanetary" width="100%" /></center>
</div>
<figure>
...
<figure>
  <ContentImage src="/learning-course/stage1/1c/telescope/crush-block-plate.webp" alt="Crush block and crush plate" width="65%" />
...
<Slides images={[
  { src: "/learning-course/stage1/1c/telescope/parts-0.webp" },
  { src: "/learning-course/stage1/1c/telescope/parts-1.webp" },
  { src: "/learning-course/stage1/1c/telescope/parts-2.webp" },
  { src: "/learning-course/stage1/1c/telescope/parts-3.webp" },
  { src: "/learning-course/stage1/1c/telescope/parts-4.webp" },
  { src: "/learning-course/stage1/1c/telescope/parts-5.webp" },
  { src: "/learning-course/stage1/1c/telescope/parts-6.webp" },
  { src: "https://www.youtube.com/embed/Kt2l8vujAUE" },
  { src: "/learning-course/stage1/1c/telescope/parts-8.webp" },
  { src: "/learning-course/stage1/1c/telescope/parts-9.webp" },
  { src: "/learning-course/stage1/1c/telescope/parts-10.webp" },
  { src: "/learning-course/stage1/1c/telescope/parts-11.webp" },
  { src: "/learning-course/stage1/1c/telescope/parts-12.webp" },
  { src: "/learning-course/stage1/1c/telescope/parts-13.webp" },
  { src: "/learning-course/stage1/1c/telescope/parts-14.webp" },
  { src: "/learning-course/stage1/1c/telescope/parts-0.webp" }
]}>
...
2. Use two extrudes to create the solid bodies for the tubes. Then, use the Tube Converter Featurescript (or shell feature) to convert the solid bodies into two thin-wall tubes with no hole pattern.

3. Add the holes for the WCP bearing blocks to the inner and outer tubes. The dimensions are from <a href="https://docs.wcproducts.com/greyt-telescope/overview-and-features/tubing-hole-pattern">WCP's documentation</a>.

4. Model the crush block at the top of the inner tube. Make sure to account for 3D-printing tolerances by giving a little bit of clearance for the crush block inside of the tube. You will add the holes that go through the crush block after you model the hook.
...
10. Extrude the plate. This plate will not be pocketed so that the surface clamped to the tube is spreads out the force. Optionally, you could partially pocket it and leave 1/16" of material on the side of the plate clamped against the tube.

11. Add a 10-32 hole for the bolt that is threaded into the gearbox plate, then mirror the plate to the other side.

12. Model the gearbox spacer and the shaft.

13. Use the mate connector at the end of the sketched rope line to create a sketch of a 3mm circle lined up with the center of the shaft.

14. Sweep the circle along the vertical line from the gearbox to create a model of the rope.

15. Finish the part studio by naming your features and putting them into folders. Also assign materials according to the reference design.
...
<Slides images={[
  { src: "/learning-course/stage1/1c/telescope/assy-0.webp" },
  { src: "https://www.youtube.com/embed/ch1kZ_IOCjs" },
  { src: "/learning-course/stage1/1c/telescope/assy-2.webp" },
  { src: "https://www.youtube.com/embed/Vt1ld7z8ovI" },
  { src: "https://www.youtube.com/embed/i4Kcsdnsk8A" },
  { src: "/learning-course/stage1/1c/telescope/assy-5.webp" },
  { src: "/learning-course/stage1/1c/telescope/assy-6.webp" },
  { src: "/learning-course/stage1/1c/telescope/assy-7.webp" },
  { src: "/learning-course/stage1/1c/telescope/assy-8.webp" },
  { src: "/learning-course/stage1/1c/telescope/assy-0.webp" }
]}>
...
3. Insert and fasten the WCP GreyT telescope bearing blocks from the <a href="https://cad.onshape.com/documents/3f21b4b70302525a1e1f2c29/v/4ec8cc58f734f29f41a0fdb8/e/4646e6fc60ff8c4fe2a9d4dd" target="_blank">WCP GreyT telescope document</a>.
...
6. Insert and fasten the MAXPlanetary gearbox and NEO Vortex from FRCDesignLib. We will use the 90 degree output with a 25:1 gear ratio.
...
<YouTube id="6oiVBMGkCOs">Creating a section view to get a better view of the pinning bolt.</YouTube>
</Aside>

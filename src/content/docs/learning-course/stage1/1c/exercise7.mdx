...
<ContentFigure src="../img/1c/vertical-rollers/3dp-spacer.webp" alt="3D printed spacer block" width="65%">Multiple spacers can be combined into single 3D printed block to reduce part count.</ContentFigure>
</Aside>

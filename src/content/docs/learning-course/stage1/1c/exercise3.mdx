...
<ContentFigure src="../img/1c/shooter/3dp-pulleys.webp" alt="3D printed pulleys with various inserts" width="80%">3D-printed pulleys with hex insert for hex shaft (left), SplineXS insert for Kraken motors (center), and pinion gear insert for NEO/CIM motors (right).</ContentFigure>
</Aside>
...
<ContentFigure src="../img/1c/shooter/nut-strips-real.webp" alt="Nut strips in use" width="65%">Nut strips can be used to connect a plate to a tube or a plate to a perpendicular plate. (Photo Credits: FRC 4414)</ContentFigure>
</Aside>
...
<ContentFigure src="../img/1c/shooter/block-motor-example.webp" alt="Block motor example" width="90%" border />

...
<figure>
  <img src="/learning-course/stage1/1c/shooter/3dp-pulleys.webp" style="width:80%" alt="3D printed pulleys with various inserts" />
...
<figure>
  <img src="/learning-course/stage1/1c/shooter/nut-strips-real.webp" style="width:65%" alt="Nut strips in use" />
...
<figure>
  <img src="/learning-course/stage1/1c/shooter/block-motor-example.webp" style="width:90%; border:5px solid #ADADAD" alt="Block motor example" />
</figure>
...
<Slides images={[
  { src: "/learning-course/stage1/1c/shooter/parts-0.webp", caption: "0. Final Part Studio." },
  { src: "/learning-course/stage1/1c/shooter/parts-1.webp", caption: "1. Create the layout sketch on the Right plane. Begin by sketching the 4\" shooter wheel, 2\" feeder wheel, and the ball path." },
  { src: "/learning-course/stage1/1c/shooter/parts-2.webp", caption: "2. On the right plane, create a new sketch with the belts, pulleys, and motors. The bottom most construction line defines the bottom of our shooter." },
  { src: "/learning-course/stage1/1c/shooter/parts-3.webp", caption: "3. Using a mate connector offset 1.375\" from the layout sketch plane as the sketch plane, sketch the side plate. Use a circular pattern to sketch the #10-32 clearance holes around the shooter hood." },
  { src: "/learning-course/stage1/1c/shooter/parts-4.webp", caption: "4. Extrude the plate as 1/4\", then mirror it across the Right plane. We use a mirror because the opposite side plate is the same except for an extra cutout for the motors." },
  { src: "/learning-course/stage1/1c/shooter/parts-5.webp", caption: "5. Sketch a cutoff boundary to remove the motor mounting from the mirrored plate. Make sure imprinting is enabled. You don't need to sketch the whole region, since the plate outline itself will be used in the extrude." },
  { src: "/learning-course/stage1/1c/shooter/parts-6.webp", caption: "6. Extrude the motor mounting region on the mirrored part to remove the geometry from the part." },
  { src: "/learning-course/stage1/1c/shooter/parts-7.webp", caption: "7. Model the large 3D print that goes in between the plates. Try to minimize the amount of dimensions you need by using the layout or part geometry. Use an \"Up to face\" extrude to ensure that the width is parametric." },
  { src: "https://www.youtube.com/embed/rGf0Vt8ahOQ", caption: "8. Use the `Fillet All Edges` Featurescript to add a 3/16\" radius fillet to all of the 3D-printed part edges. To select the face of the part, you can utilize the `Isolate` tool, which will make all other components that are not currently selected transparent or hidden." },
  { src: "https://www.youtube.com/embed/DUJ8MbPS4Zg", caption: "9. Insert a block motor from FRCDesignLib. Use the `Transform` feature to transform the block motor to the motor bore." },
  { src: "/learning-course/stage1/1c/shooter/parts-10.webp", caption: "10. Add the HTD 5mm pitch belts. Double check that the pitch length is a multiple of 5 mm to ensure that the belt has an integer number of teeth." },
  { src: "https://www.youtube.com/embed/wFNDLm2Tisc", caption: "11. Model the shooter wheel and feeder wheel shaft using the `Robot Shaft` featurescript." },
  { src: "https://www.youtube.com/embed/L8HWApw3luM", caption: "12. Add a mate connector on the layout sketch for fastening the feeder wheel. Set the owner of the mate connector to the feeder shaft. This mate connector marks the center point between the two plates and will help with assembly." },
  { src: "/learning-course/stage1/1c/shooter/parts-13.webp", caption: "13. Repeat the same steps as before to add a mate connector to the shooter wheel shaft. Make sure you select the shooter wheel shaft as the mate connector owner." },
  { src: "/learning-course/stage1/1c/shooter/parts-0.webp", caption: "14. Finish the part studio by naming your features and organizing them into folders." }
]} />
...
<Slides images={[
  { src: "/learning-course/stage1/1c/shooter/assy-0.webp", caption: "0. Final assembly." },
  { src: "/learning-course/stage1/1c/shooter/assy-1.webp", caption: "1. Insert all the part studio components. Group all the components except for the shafts and belts. Fasten the Origin Cube to the origin." },
  { src: "https://www.youtube.com/embed/7Zplj3xG83s", caption: "2. Insert and fasten 4.5\" long nut strips from the FRCDesignLib app. Pay close attention to which side is fastened to the plate - the nut strip holes on adjacent sides are staggered." },
  { src: "/learning-course/stage1/1c/shooter/assy-3.webp", caption: "3. Insert and fasten the two NEO motors. Insert, fasten, and replicate the bearings." },
  { src: "https://www.youtube.com/embed/RsCl6xD8tMs", caption: "4. Insert and configure the shooter pulley to be 24T with 1/2\" Hex w/ TTB insert. Copy and paste the pulley and TTB insert to create the motor pulley. Using a 3/16\" spacer, fasten the shooter pulley to the shooter bearing. Then, fasten the motor pulley to the belt. Finally, use the `Isolate` tool to fasten the 8mm NEO shaft to 1/2\" hex adapter." },
  { src: "https://www.youtube.com/embed/vEuopW1B9r4", caption: "5. Insert and configure the feeder pulley to be 36T with a TTB 1/2\" hex insert. Configure the motor pulley to be 18T with a 12T 20DP gear insert. Using a 1/16\" spacer, fasten the feeder pulley to the feeder bearing. Then, fasten the motor pulley to the belt. Finally, use the `Isolate` tool to fasten the 12T motor pinion." },
  { src: "/learning-course/stage1/1c/shooter/assy-6.webp", caption: "6. Fasten the shafts to the pulleys." },
  { src: "https://www.youtube.com/embed/GuyhDXkKwho", caption: "7. Insert and fasten the shooter and feeder wheels to the shaft centering mate connectors. Then, Use the `Measure` tool to measure the gaps between the bearings and the wheels. Create spacers to fill the gaps on the sides of the wheels. Finally, use the `Assembly Mirror` tool to mirror the spacers and the shooter wheel across the feeder wheel's mate connector." },
  { src: "/learning-course/stage1/1c/shooter/assy-8.webp", caption: "8. Insert and fasten the 4\" SDS Flywheel to the other side of the shooter." },
  { src: "/learning-course/stage1/1c/shooter/assy-9.webp", caption: "9. Insert, fasten, and replicate all of the required fasteners and remaining hardware." },
  { src: "/learning-course/stage1/1c/shooter/assy-0.webp", caption: "10. Finish your assembly by organizing the parts into folders and naming your replicates. You can also insert and position the ball to visualize it." }
]} />
...
<YouTube id="I1nFphxKVXc" caption="Isolate parts, hide parts, or make parts transparent to help with assembly." />
</Aside>

...
:::figure
![Different spacer types](../img/1c/direction-swap/spacers.webp)
Spacers can be 3D printed (left), purchased as COTS pre-cut spacers (center), or fabricated in-house from spacer stock (right). (Image Source: WCP)
:::
</Aside>
...
<video width="100%" controls>
  <source src="/learning-course/stage1/1c/driven-dims.webm" type="video/webm" />

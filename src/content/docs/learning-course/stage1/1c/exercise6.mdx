...
<figure>
  <img src="/learning-course/stage1/1c/direction-swap/spacers.webp" width="100%" alt="Different spacer types" />
...
<Slides images={[
  { src: "/learning-course/stage1/1c/direction-swap/parts-0.webp", caption: "0. Final Part Studio." },
  { src: "/learning-course/stage1/1c/direction-swap/parts-1.webp", caption: "1. Begin by creating the layout sketch on the right plane." },
  { src: "/learning-course/stage1/1c/direction-swap/parts-2.webp", caption: "2. Using a mate connector offset 0.5\" from the Right plane as the sketch plane, sketch the plate. Pay close attention to the clearances used to define the edges of the plate. The location of the two spacers to the left of the motor are driven by the tangency between the 3/8\" OD spacer and the 2.5\" motor clearance circle." },
  { src: "/learning-course/stage1/1c/direction-swap/parts-3.webp", caption: "3. Use a `Driven Dimension` to show the distance between the left gear and the spacer and verify that there is enough clearance. A driven dimension, as opposed to a driving dimension, just reports the distance between the selected elements and is faded gray to indicate that it does not define the sketch geometry." },
  { src: "/learning-course/stage1/1c/direction-swap/parts-4.webp", caption: "4. Mirror the plate across the Right plane and add the motor cutout." },
  { src: "/learning-course/stage1/1c/direction-swap/parts-5.webp", caption: "5. If you choose to not use COTS spacers, you can use the `Robot Spacer` Featurescript to create the plate spacer." },
  { src: "/learning-course/stage1/1c/direction-swap/parts-6.webp", caption: "6. Model all of the shafts and belts. You should be feeling very comfortable using the `Robot Shaft` and `Belt & Chain Gen` Featurescripts at this point." },
  { src: "/learning-course/stage1/1c/direction-swap/parts-7.webp", caption: "7. Pocket the two plates. Since the plates are identical apart from the motor cutout, you can use same sketch to pocket both plates. Only create one sketch with the ribs." },
  { src: "/learning-course/stage1/1c/direction-swap/parts-0.webp", caption: "7. Finish the part studio by naming your features and organizing them into folders. Assign the part materials accordingly." }
]} />
...
<Slides images={[
  { src: "/learning-course/stage1/1c/direction-swap/assy-0.webp", caption: "0. Final assembly." },
  { src: "/learning-course/stage1/1c/direction-swap/assy-1.webp", caption: "1. Add the part studio parts to the assembly. Like before, group mate the rigid components with the Origin Cube and mate the Origin Cube to the assembly origin." },
  { src: "/learning-course/stage1/1c/direction-swap/assy-2.webp", caption: "2. Fasten the spacer to the plate and replicate it." },
  { src: "/learning-course/stage1/1c/direction-swap/assy-3.webp", caption: "3. Insert, fasten, and replicate the bearings. Also insert a 2\" flex wheel and Kraken X60 motor from FRCDesignLib." },
  { src: "/learning-course/stage1/1c/direction-swap/assy-4.webp", caption: "4. Insert and fasten the pulleys and spacers. For the pulleys, you can utilize 3D printed HTD pulleys from the FRCDesignLib with 1/2\" hex inserts. Also fasten the belts into place." },
  { src: "/learning-course/stage1/1c/direction-swap/assy-5.webp", caption: "5. Insert a configurable spacer stack from FRCDesignLib. The length should be the distance between the pulley and flex wheel. The spacer stack will display an error most likely. This error can be cleared by deselecting the spacer lengths not present in the stack. Alternatively you can make your own stack of COTS spacers, or use a single long custom spacer." },
  { src: "/learning-course/stage1/1c/direction-swap/assy-6.webp", caption: "6. Add in and replicate all of the required fasteners to complete the design." },
  { src: "/learning-course/stage1/1c/direction-swap/assy-0.webp", caption: "7. To finish the assembly, organize your components into folders and name your replicates." }
]} />
...
<figure>
  <video width="100%" controls>
    <source src="/learning-course/stage1/1c/direction-swap/driven-dims.webm" type="video/webm" />

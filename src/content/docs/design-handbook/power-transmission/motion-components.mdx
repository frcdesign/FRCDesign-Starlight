...
description: "A guide on bearings, bushings, and axles used in FRC power transmission."
---
...
There are other applications of bearings, such as in elevator bearing blocks where they slide along a surface to allow for less friction, however this section is dedicated specifically for bearings' use in rotational systems. 
...
<ContentFigure src="../img/power-transmission/bearing-context.png" alt="" width="70%">
  Flanged bearing used on rollers for 1678's 2024 robot.
</ContentFigure>
...
<ContentFigure src="../img/power-transmission/standard-bearing-context.png" alt="" width="50%">
  Standard bearing in gearbox. The plate is half pocketed so that the bearing doesn't fall out, and is retained by a custom axle.
</ContentFigure>

### Needle Bearings

Needle bearings are a special type of bearing which is much thinner than flanged and standard bearings. They can be used in spaces where there is not enough space for a normal bearing and are almost always used for round axles. As a result, they are a common option to use with [dead axle rollers](/learning-course/stage1/1c/exercise2/) as they can be press fit into the end caps. 

<ContentFigure src="../img/power-transmission/1540needlebearing.png" alt="" width="70%">
  Needle bearing used in dead axle rollers for 1540's 2025 intake. Allows roller to spin around a rigid axle.
</ContentFigure>
...
<ContentFigure src="../img/power-transmission/x-contact-context.png" alt="" width="70%">
  X-Contact bearing in an MK4 swerve module. Allows wheel to rotate freely.
</ContentFigure>


<ContentFigure src="../img/power-transmission/JGKWXv2OdJCRBAJ8O1yNFD2TTZEuUdvi.webp" alt="" width="90%">
  X-Contact bearing setup. The ball is contacted on 4 points instead of 2 in standard bearings.
</ContentFigure>

<ContentFigure src="../img/power-transmission/TypeC.webp" alt="" width="90%">
  Standard ball bearing setup. Ball is contacted on 2 points vertically.
</ContentFigure>


This setup allows X-Contact bearings to withstand much more [thrust](https://en.wikipedia.org/wiki/Thrust_bearing) force than typical bearings, meaning it can withstand loads laterally rather than rotationally. This is very useful for places where a lot of weight is against the bearing vertically, such as in swerve modules where the bearings must be able to hold the entire weight of the robot. 

## Bushings

A common type of bearing used in FRC are bushings. Bushing are often used for high torque, low speed applications, such as [dead axle pivots](/learning-course/stage2/2b/introduction/). They are much simpler than ball bearings; instead of using balls to allow for smooth rotational movement, axles simply rotate on a self-lubricating surface (i.e. brass). Although bearings are the preferred solution in most cases because they reduce friction and support load most effectively, in low speed applications bushings have the upper hand for being smaller and lighter than bearings. They usually have a flange but other types can be sourced from non-FRC vendors. 

<ContentFigure src="../img/power-transmission/citrus-bushing.png" alt="" width="50%">
  Bushing mounted to 1678 2024 shooter, which allows it to pivot freely around an axle.
</ContentFigure>

## Other Bearings

There are a wide variety of bearings with limited use in FRC, such as thrust bearings or linear bearings. These types of bearings usually have specific use cases not relevant to FRC. More information about them can be found on [McMaster-Carr's website](https://www.mcmaster.com/products/bearings/), a common vendor in industry.
...
<ContentFigure src="../img/power-transmission/axleExample.png" alt="" width="70%">
  Typical 1/2" rounded hex axle on two bearings, retained with bolts.
</ContentFigure>
...
<ContentFigure src="../img/power-transmission/hexpivotfun.png" alt="" width="50%">
  Twisted steel hex axle, 1/2" diameter. Was used for pivoting an extremely large load.
</ContentFigure>
...
<ContentFigure src="../img/power-transmission/typesofshaftprofiles.png" alt="" width="90%">
  Various types of profiles. Left to right: Churro, Hex (standard), MAXSpline, Round (1")
</ContentFigure>
...
<ContentFigure src="../img/power-transmission/bearinghat1540.png" alt="" width="50%">
  3D printed bearing hat on 1540's 2025 end effector.
</ContentFigure>
...
<ContentFigure src="../img/power-transmission/2910-shaft-tech.webp" alt="" width="50%">
  Shaft collar retaining a 1/2" hex axle on 2910's climb axles. Note that the flanges of the bearings are pointing towards each, with only one lock collar used.
</ContentFigure>
...
<ContentFigure src="../img/power-transmission/1540retainingring.png" alt="" width="50%">
  Machined groove on 1540's 2025 arm shaft, allows a retaining ring to be put on.
</ContentFigure>
...
<ContentFigure src="../img/power-transmission/6328hexthing.png" alt="" width="50%">
  Custom hex axle on 6328's pivot gearbox, 2023. Note that the unaffected part of the hex axle holds the bearing in.
</ContentFigure>
...
Some vendors, like WCP or AndyMark, sell custom shafts. These [output shafts](https://wcproducts.com/collections/systems-structure/products/output-shafts) are helpful in certain scenarios. However, these are often not necessary and are mostly used to ease assembly or under design constraints.

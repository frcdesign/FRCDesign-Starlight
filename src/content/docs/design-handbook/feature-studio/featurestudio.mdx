...
description: "An introduction to writing custom FeatureScripts in Onshape Feature Studio."
---

<Aside type="note">
For many teams, writing your own FeatureScripts is not necessary. There are plenty of pre-made FeatureScripts addressed [here](/resources/featurescripts/)
</Aside>
## Syntax
...
### Functions
A function is a block of code that is easily reusable and performs a specific task. To define a function, you type `function myFunctionName()`. If you need to pass things into the function, you can use the syntax `function myFunctionName(var1 is Type)`. To execute the function, you can call it with the syntax `myFunctionName(var1)`
...
![alt text](./img/no-annotation-input.webp)
...
```
![alt text](./img/annotated-input.webp)
...
<ContentFigure src="./img/featurestudio-ex1.webp" alt="" width="80%" gif />
...
<ContentFigure src="./img/featurestudio-ex2.webp" alt="" width="80%" gif />
...
<ContentFigure src="./img/featurestudio-ex3.webp" alt="" width="80%" gif />

...
<ContentFigure src="../img/structure/tube-plug.webp" alt="Tube plug" width="40%"/>
...
<ContentFigure src="../img/structure/simplest-crush.webp" alt="Simplest crush block" width="30%"/>
